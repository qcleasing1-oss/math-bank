# -*- coding: utf-8 -*-
"""รวมไฟล์ข้อเดี่ยวของก้อน 21 เป็นไฟล์สเตจใน /home/claude/k2/out/

⛔ ยึด stems_b21.py เป็นความจริง — _guard() เทียบทุกสนามทีละตัวอักษร
...
for _n in range(145, 165):
    _p = '/home/claude/k2/parts_b21/q%03d.py' % _n
...
FN = 'k2-ก้อน21-20ข้อ-7.1-7.11-7.2-7.3-7.4.json'
