# -*- coding: utf-8 -*-
"""ด่านตรวจไฟล์ข้อเดี่ยวของก้อน 20 — ผู้แต่งแต่ละคนรันกับไฟล์ของตัวเองก่อนส่งงาน

    python3 /home/claude/k2/check_part_b20.py 105
...
n = int(sys.argv[1])
p = '/home/claude/k2/parts_b20/q%03d.py' % n
bad = []
