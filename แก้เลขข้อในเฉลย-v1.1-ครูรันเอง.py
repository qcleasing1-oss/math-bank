# -*- coding: utf-8 -*-
"""
แก้ "เลขข้อ" ที่พิมพ์ผิดในบรรทัดคำตอบ   (v1.1 · ครูรันเอง)
===========================================================================
...
# ── 16 ข้อที่ด่านอัตโนมัติยืนยันไม่ได้ (ตัวเลือกเป็นสัญลักษณ์ตัวเดียว หรือถ้อยคำต่างกัน)
# ⬤ E เปิดดูทีละข้อกับคลังจริงแล้ว ยืนยันว่า "ค่าคำตอบในเฉลย = ตัวเลือกที่คลังเก็บ" ทั้ง 16 ข้อ
#   เช่น q242 เฉลย «ข้อ 0 คือ $r$» · ตัวเลือกที่คลังติ๊กคือ [1] $r$  ⇒ ค่าถูก เลขผิด
# ⛔ chap-02-logic-q37 ⛔ ไม่อยู่ในรายชื่อนี้ เพราะข้อนั้นเฉลย "ผิดจริง" ต้องใช้สคริปต์วางเฉลยใหม่
REVIEWED_OK = set("""
gen-chap-02-logic-q242 gen-chap-02-logic-q243 gen-chap-02-logic-q249
gen-chap-02-logic-q251 gen-chap-02-logic-q254 gen-chap-02-logic-q260
gen-chap-04-coord-q028 gen-chap-04-coord-q062 gen-chap-04-coord-q063
gen-chap-04-coord-q064 gen-chap-04-coord-q072 gen-chap-04-coord-q108
gen-chap-04-coord-q141 gen-chap-04-coord-q152 gen-chap-04-coord-q157
gen-chap-05-function-q017
""".split())
...
def plan_for(q):
    ...
    if not ok and q.get("id") not in REVIEWED_OK:
