...
NO_TOP_SETID: dict[str, str] = {
    # 🔻 7 ส.ค. 69 : ว่างแล้ว — 4 ไฟล์เดิม (pat1-2553-10 · 2558-10 · 2559-03 · 2560-03)
    #    ถูกเติม `setId` บนสุดครบที่ใบก้าว 3 ของก้อน 20+21 (E→MB #30 §12ⓐ)
    #    เติมฟิลด์อย่างเดียว ⛔ ไม่แตะ id ไม่แตะเนื้อหา
    #    ⛔ รายการนี้ย่อได้อย่างเดียว — ห้ามเติมชื่อใหม่เพื่อให้ด่านเขียว
}
