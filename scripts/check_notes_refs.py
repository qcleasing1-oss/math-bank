...
**🔑 ชื่อ 5 ตัวที่ ⛔ ไม่มีอยู่จริง — ยืนยันแล้ว 3 ขาอิสระ (⛔ ไม่ใช่ขาเดียว)**
     ...
     ขา ② สำเนาทำงานบนดิสก์ครู `…\\math-bank\\tools\\authoring\\k2\\` (MB อ่านรายการเอง 13 ส.ค.)
          ⇒ มี `collide_b3…b19` และ `collide_b22.py` ครบ · **⛔ ไม่มีของ b20 / b21**
     ขา ③ ซองส่งมอบ `…\\_delivery-ก้อน20-21\\tools-b20-b21.tar.gz` (62 รายการ · MB แตกอ่านเอง)
...
# 🔑 ชื่อ 5 ตัวที่หายไป — เก็บเป็น **ข้อมูล** เพื่อให้ selftest ยืนบนข้อมูล ⛔ ไม่ยืนบนถ้อยคำ
